       ...
       <div className=' w-34'>  {/*custom style */}
          <p onClick={()=>setShowFilter(!showFilter)} className='text-gray-700 text-xl my-2 font-semibold flex items-center gap-2 cursor-pointer'>FILTERS
           ...
           <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter?'':'hidden'} sm:block`}>
            ...
            <div className='flex flex-col gap-2 text-sm font-light text-gray-700 '>
              <p className='flex gap-2'>
                <input type="checkbox" className='w-3' onClick={toggleSubCategory} value={'Topwear'} />Topwear
              </p>
              <p className='flex gap-2'>
                <input type="checkbox" className='w-3' onClick={toggleSubCategory} value={'Bottomwear'} />Bottomwear
              </p>
              <p className='flex gap-2'>
                <input type="checkbox" className='w-3' onClick={toggleSubCategory} value={'Winterwear'} />Winterwear
              </p>
            </div>
           </div>
      </div>
